...
def generate_launch_description():
    frames_path = "/home/student/Desktop/scenario/frames/frames_ur3"
    rviz_config_file = "/home/student/Desktop/scenario/config/config_ur10.rviz"
    robot_dir = "/home/student/requirements_ws/src/chalmers_robots_info/case_r4"

    urc_setup_dir = FindPackageShare("ur_controller").find("ur_controller")

    ur_controller_params = {
        "simple_robot_simulator": False,
        "templates_path": os.path.join(urc_setup_dir),
        "prefix": "" #"r1_",
    }

    urscript_driver_parameters = {
        "ur_address": "192.168.100.42",
        "tf_prefix": "",
    }

    parameters = {"scenario_path": frames_path}

    robot_parameters_path = os.path.join(robot_dir, "general.json")
    ...
    ur_script_driver_node = Node(
        ...
        namespace="",
        output="screen",
        parameters=[urscript_driver_parameters],
        remappings=[("/tf", "tf"), ("/tf_static", "tf_static")],
    )
